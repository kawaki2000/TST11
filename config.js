...
const baseConfig = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '22781289418-1632403322@g.us',
    ...
    RG: process.env.RG || '22781289418-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'TST;KAWAKI;0;https://files.catbox.moe/iakfm4.jpg;https://chat.whatsapp.com/Jlb1pobu4GGK0UZwi4toSe',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "kawaki227",
    BOT_NAME: process.env.BOT_NAME || '𝙺𝙰𝚆𝙰𝙺𝙸²²7',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝙺𝙰𝚆𝙰𝙺𝙸²²7ꫂ;TEST-BOT MD bot;https://files.catbox.moe/iakfm4.jpg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "22782639423",
